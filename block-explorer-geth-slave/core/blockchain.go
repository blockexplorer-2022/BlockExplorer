...
func (bc *BlockChain) InsertHeaderChain(chain []*types.Header, checkFreq int) (int, error) {
	//fmt.Println("blockchain.go-> InsertHeaderChain()")
	start := time.Now()
	//hzy delete
/*	if i, err := bc.hc.ValidateHeaderChain(chain, checkFreq); err != nil {
		fmt.Println("blockchain.go-> InsertHeaderChain()->error occur ",err)
		return i, err
	}*/
    //end
	...
	whFunc := func(header *types.Header) error {
		...
		//fmt.Println("blockchain.go(2116lines)-> InsertHeaderChain()",err)
		return err
	}
